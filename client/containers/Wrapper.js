...
export function AframeVR (props){
        ...
        var rotations = ['0 0 0', '0 0 0', '0 -90 0', '0 -90 0', '0 180 0', '0 180 0', '0 90 0', '0 90 0'];
            ...
            <Scene physics="friction: 0.1; restitution: 0.5">
                <a-assets>
                    <a-asset-item id="frame-obj" src="/models/Frame/Old_picture_frame.obj" />
                    <a-asset-item id="frame-mtl" src="/models/Frame/Old_picture_frame.mtl" />
                ...
                <a-plane height="20" width="20" src="textures/Brick_wall.jpg" position="-4.17 7.831 -1.71" rotation="0 90 0" />
                <a-plane height="20" width="20" src="textures/Brick_wall.jpg" position="0.573 7.741 -9.667" rotation="0 0 0" />
                <a-plane height="20" width="20" src="textures/Brick_wall.jpg" position="5.157 8.266 0.114" rotation="0 -90 0" />
                <a-plane height="20" width="20" src="textures/Brick_wall.jpg" position="4.729 8.618 2.151" rotation="0 180 0" />
                <a-plane color="#CCC" height="20" width="20" position="-2.89 0.047 -4.31" rotation="-90 0 0" />
                <a-plane color="#CCC" height="20" width="20" position="5.680 7.015 0.019" rotation="90 0 0" />
                {/* {models && models.map(model =>{
                    return(
                ...
                { images && images.map((image, index) => {
                    ...
                    <a-entity key={index} obj-model="obj:#frame-obj" material= "color:blue" position={positions[index]} rotation={rotations[index]} scale="2.5 2.5 1">
                        <a-image src={image.url} position="0 .4 0" scale="1 .7 1" />
                    </a-entity>
                );})
                }
            </Scene>
