    ...
    render(){
        ...
        return(
            ...
            ></a-entity>
                ...
                <a-box src="/img/exitsign.png" href={'/galleries'} position="-1 0 3.5"></a-box>
                <a-box src="/img/back_button.png" href={`/vr/artists/${currentArtistId}/starry`} position="1 0 3.5"></a-box>
