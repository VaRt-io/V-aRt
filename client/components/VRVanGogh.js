...
class VRVanGogh extends Component{
    ...
    render(){
        ...
        return (
            paintings ?
            <Scene>
            <a-asset-item id="starryNight" src="/models/vangogh/untitled-scene.obj" />
            <a-asset-item id="starryNight-mtl" src="/models/vangogh/untitled-scene.mtl" />
            <a-asset-item id="room" src="/models/vangogh/room.obj" />
            <a-asset-item id="room-mtl" src="/models/vangogh/room.mtl" />
            <a-asset-item id="saturn-obj" src="/models/saturn/saturn.obj" />
            <a-asset-item id="saturn-mtl" src="/models/saturn/saturn.mtl" />
            <a-asset-item id="jupiter-obj" src="/models/jupiter/jupiter.obj" />
            <a-asset-item id="jupiter-mtl" src="/models/jupiter/jupiter.mtl" />
            ...
            <a-entity
              obj-model="obj:#jupiter-obj; mtl:#jupiter-mtl"
              position="130 0 0"
              scale="1000 1000 1000"
            />
                <a-sky src={nightSky} />
