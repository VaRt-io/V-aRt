    ...
    return (
          ...
          {/*
            <div id="landingPageHeader" style={{marginLeft:'27vw'}}>
              <h3 style={{margin: '30px 0px 0px -20px'}}>V-aRt. . .merging the technology of virtual reality</h3>
              <h3 style={{margin: '0px 0px 0px 180px'}}>with the talent of artists arcoss the Globe.</h3>
