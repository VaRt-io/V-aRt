...
export default class VR2 extends Component{
    ...
    render(){
        ...
        <a-torus-knot src={cyberRust} position ="-5 2 -10" ></a-torus-knot>
        <a-dodecahedron src="#circutBoard" position= "5 8 -5" ></a-dodecahedron>
        <a-text value ="Hello V-aRt" position="-1 2 -3" color="white"></a-text>
         <a-cylinder src="#marbleTexture" position="-3 0.75 -3" radius="0.5" height="1.5" rotation="90 0 0" color="gold"></a-cylinder>
        
        <a-plane src={groundTexture} position="0 0 -4" rotation="-90 0 0" width="90" height="90dssa" repeat="10 10" ></a-plane>

        <a-sky src= {nightScape}></a-sky>
          </Scene>
        );
