...
import {LandingPage,  OurNavbar, AllArtists, SingleArtist, AllGalleries, SingleGallery, VR, VR2, CanvasWrapper, GalleryCreate, SinglePainting, GalleryEdit, Signup, Signin, ArtistDashboard, VRWrapper, VRNightScene, VRCube, VRDesert, VRCity} from './index';
    ...
    return (
      ...
      <div id="landingBackground">
        ...
        <Switch>
          ...
          <Route exact path="/vr/:id/city" component={VRCity} />
